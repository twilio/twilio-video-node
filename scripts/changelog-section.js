...
// CHANGELOG.md ships in the tarball, so an undated heading would be published
// as the release notes.
if (/\(In Progress\)/i.test(heading)) {
  fail(
    `The ${expected} heading still reads "(In Progress)". ` +
      'Replace it with the release date before releasing.',
  );
}
